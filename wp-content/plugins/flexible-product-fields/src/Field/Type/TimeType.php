...
/**
 * Supports "Time" field type.
 */
class TimeType extends TypeAbstract {

	const FIELD_TYPE = 'time';
	...
	public function get_field_type_label(): string {
		return __( 'Time', 'flexible-product-fields' );
	}
	...
	public function get_options_objects(): array {
		return [
			...
			AdvancedTab::TAB_NAME => [
				Hour12ClockOption::FIELD_NAME => new Hour12ClockOption(),
				MinuteStepOption::FIELD_NAME  => new MinuteStepOption(),
			],
			PricingTab::TAB_NAME  => [
	...
	public function get_field_template_vars( array $field_data ): array {
		...
		$template_vars['minute_step'] = $field_data[ MinuteStepOption::FIELD_NAME ];
