<?php
/**
 * This template can be overridden by copying it to yourtheme/flexible-product-fields/fields/paragraph.php
 *
...
<div class="fpf-field fpf-<?php echo esc_attr( $type ); ?>">
	<p class="<?php echo esc_attr( $class ); ?>" id="<?php echo esc_attr( $key ); ?>_field">
