 ...
 */
class MongoDBFormatter implements \VendorFPF\Monolog\Formatter\FormatterInterface
{
    /** @var bool */
    ...
    protected function formatObject($value, int $nestingLevel)
    {
        ...
        $objectVars['class'] = \VendorFPF\Monolog\Utils::getClass($value);
    ...
    {
        $formattedException = ['class' => \VendorFPF\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => (int) $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine()];
