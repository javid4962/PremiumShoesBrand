 ...
 */
abstract class AbstractSyslogHandler extends \VendorFPF\Monolog\Handler\AbstractProcessingHandler
{
    /** @var int */
    protected $facility;
    /**
     ...
     */
    protected $logLevels = [\VendorFPF\Monolog\Logger::DEBUG => \LOG_DEBUG, \VendorFPF\Monolog\Logger::INFO => \LOG_INFO, \VendorFPF\Monolog\Logger::NOTICE => \LOG_NOTICE, \VendorFPF\Monolog\Logger::WARNING => \LOG_WARNING, \VendorFPF\Monolog\Logger::ERROR => \LOG_ERR, \VendorFPF\Monolog\Logger::CRITICAL => \LOG_CRIT, \VendorFPF\Monolog\Logger::ALERT => \LOG_ALERT, \VendorFPF\Monolog\Logger::EMERGENCY => \LOG_EMERG];
    /**
     ...
     */
    public function __construct($facility = \LOG_USER, $level = \VendorFPF\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
    ...
    {
        return new \VendorFPF\Monolog\Formatter\LineFormatter('%channel%.%level_name%: %message% %context% %extra%');
    }
}
