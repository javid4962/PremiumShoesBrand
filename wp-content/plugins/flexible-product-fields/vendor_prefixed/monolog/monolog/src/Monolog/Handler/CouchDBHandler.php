 ...
 */
class CouchDBHandler extends \VendorFPF\Monolog\Handler\AbstractProcessingHandler
{
    /** @var mixed[] */
    private $options;
    /**
     * @param mixed[] $options
     */
    public function __construct(array $options = [], $level = \VendorFPF\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
