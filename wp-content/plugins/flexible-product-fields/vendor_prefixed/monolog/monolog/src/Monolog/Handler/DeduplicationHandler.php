 ...
 */
class DeduplicationHandler extends \VendorFPF\Monolog\Handler\BufferHandler
{
    /**
     * @var string
     */
     ...
     */
    public function __construct(\VendorFPF\Monolog\Handler\HandlerInterface $handler, ?string $deduplicationStore = null, $deduplicationLevel = \VendorFPF\Monolog\Logger::ERROR, int $time = 60, bool $bubble = \true)
    {
        parent::__construct($handler, 0, \VendorFPF\Monolog\Logger::DEBUG, $bubble, \false);
        $this->deduplicationStore = $deduplicationStore === null ? \sys_get_temp_dir() . '/monolog-dedup-' . \substr(\md5(__FILE__), 0, 20) . '.log' : $deduplicationStore;
        $this->deduplicationLevel = \VendorFPF\Monolog\Logger::toMonologLevel($deduplicationLevel);
        $this->time = $time;
    }
