...
use VendorFPF\Elastica\Document;
 ...
 */
class ElasticaHandler extends \VendorFPF\Monolog\Handler\AbstractProcessingHandler
{
    /**
     * @var Client
     */
     ...
     */
    public function __construct(\VendorFPF\Elastica\Client $client, array $options = [], $level = \VendorFPF\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
