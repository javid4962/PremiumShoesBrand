 ...
 */
namespace VendorFPF\Monolog\Handler\FingersCrossed;
 ...
 */
class ChannelLevelActivationStrategy implements \VendorFPF\Monolog\Handler\FingersCrossed\ActivationStrategyInterface
{
    /**
     * @var Level
     */
    ...
    {
        $this->defaultActionLevel = \VendorFPF\Monolog\Logger::toMonologLevel($defaultActionLevel);
