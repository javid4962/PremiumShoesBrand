...
use VendorFPF\Monolog\Formatter\WildfireFormatter;
 ...
 */
class FirePHPHandler extends \VendorFPF\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \VendorFPF\Monolog\Formatter\WildfireFormatter();
    }
    /**
