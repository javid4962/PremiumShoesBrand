 ...
 */
class OverflowHandler extends \VendorFPF\Monolog\Handler\AbstractHandler implements \VendorFPF\Monolog\Handler\FormattableHandlerInterface
{
    /** @var HandlerInterface */
    private $handler;
    /** @var int[] */
    private $thresholdMap = [\VendorFPF\Monolog\Logger::DEBUG => 0, \VendorFPF\Monolog\Logger::INFO => 0, \VendorFPF\Monolog\Logger::NOTICE => 0, \VendorFPF\Monolog\Logger::WARNING => 0, \VendorFPF\Monolog\Logger::ERROR => 0, \VendorFPF\Monolog\Logger::CRITICAL => 0, \VendorFPF\Monolog\Logger::ALERT => 0, \VendorFPF\Monolog\Logger::EMERGENCY => 0];
    /**
     ...
     */
    public function __construct(\VendorFPF\Monolog\Handler\HandlerInterface $handler, array $thresholdMap = [], $level = \VendorFPF\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
