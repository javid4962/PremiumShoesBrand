 ...
 */
class PsrHandler extends \VendorFPF\Monolog\Handler\AbstractHandler implements \VendorFPF\Monolog\Handler\FormattableHandlerInterface
{
    /**
     ...
     */
    public function __construct(\Psr\Log\LoggerInterface $logger, $level = \VendorFPF\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
