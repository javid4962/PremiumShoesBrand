 ...
 */
class RedisHandler extends \VendorFPF\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($redis, string $key, $level = \VendorFPF\Monolog\Logger::DEBUG, bool $bubble = \true, int $capSize = 0)
    {
