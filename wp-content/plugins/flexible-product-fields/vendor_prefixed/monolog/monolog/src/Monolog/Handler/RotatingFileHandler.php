...
class RotatingFileHandler extends \VendorFPF\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \VendorFPF\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false)
    {
        $this->filename = \VendorFPF\Monolog\Utils::canonicalizePath($filename);
