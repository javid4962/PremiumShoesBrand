 ...
 */
namespace VendorFPF\Monolog\Handler\Slack;
...
class SlackRecord
{
     ...
     */
    public function __construct(?string $channel = null, ?string $username = null, bool $useAttachment = \true, ?string $userIcon = null, bool $useShortAttachment = \false, bool $includeContextAndExtra = \false, array $excludeFields = array(), \VendorFPF\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \VendorFPF\Monolog\Formatter\NormalizerFormatter();
        }
    }
    /**
    ...
    {
        switch (\true) {
            case $level >= \VendorFPF\Monolog\Logger::ERROR:
                return static::COLOR_DANGER;
            case $level >= \VendorFPF\Monolog\Logger::WARNING:
                return static::COLOR_WARNING;
            case $level >= \VendorFPF\Monolog\Logger::INFO:
    ...
    public function stringify(array $fields) : string
    {
        ...
        return $hasSecondDimension || $hasNonNumericKeys ? \VendorFPF\Monolog\Utils::jsonEncode($normalized, \JSON_PRETTY_PRINT | \VendorFPF\Monolog\Utils::DEFAULT_JSON_FLAGS) : \VendorFPF\Monolog\Utils::jsonEncode($normalized, \VendorFPF\Monolog\Utils::DEFAULT_JSON_FLAGS);
    }
    /**
    ...
    public function setFormatter(?\VendorFPF\Monolog\Formatter\FormatterInterface $formatter = null) : self
    {
