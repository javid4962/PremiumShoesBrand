 ...
 */
class TestHandler extends \VendorFPF\Monolog\Handler\AbstractProcessingHandler
{
    /** @var Record[] */
    protected $records = [];
    ...
    {
        return isset($this->recordsByLevel[\VendorFPF\Monolog\Logger::toMonologLevel($level)]);
    }
    /**
    ...
    {
        $level = \VendorFPF\Monolog\Logger::toMonologLevel($level);
