...
class Registry
{
     ...
     * @return void
     */
    public static function addLogger(\VendorFPF\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
    ...
    {
        if ($logger instanceof \VendorFPF\Monolog\Logger) {
     ...
     */
    public static function getInstance($name) : \VendorFPF\Monolog\Logger
    {
