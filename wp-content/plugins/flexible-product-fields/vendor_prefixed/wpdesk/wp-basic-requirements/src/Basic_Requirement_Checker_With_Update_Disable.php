...
if (!\class_exists('VendorFPF\\WPDesk_Basic_Requirement_Checker')) {
...
if (!\class_exists('VendorFPF\\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker_With_Update_Disable extends \VendorFPF\WPDesk_Basic_Requirement_Checker
    {
        /**
