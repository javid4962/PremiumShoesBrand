 ...
 */
class RunCodeceptionTests extends \VendorFPF\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    const SINGLE = 'single';
    const FAST = 'fast';
    ...
    {
        parent::configure();
        $this->setName('run-codeception-tests')->setDescription('Run codeception tests.')->setDefinition(array(new \VendorFPF\Symfony\Component\Console\Input\InputArgument(self::SINGLE, \VendorFPF\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Name of Single test to run.', 'all'), new \VendorFPF\Symfony\Component\Console\Input\InputArgument(self::FAST, \VendorFPF\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Fast tests - do not shutdown docker-compose.', 'slow'), new \VendorFPF\Symfony\Component\Console\Input\InputArgument(self::WOOCOMMERCE_VERSION, \VendorFPF\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'WooCommerce version to install.', '')));
    }
    /**
     * Execute command.
     *
