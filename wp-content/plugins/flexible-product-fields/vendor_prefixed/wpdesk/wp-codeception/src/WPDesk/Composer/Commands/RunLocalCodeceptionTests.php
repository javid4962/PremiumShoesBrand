...
class RunLocalCodeceptionTests extends \VendorFPF\WPDesk\Composer\Codeception\Commands\RunCodeceptionTests
{
    ...
    {
        parent::configure();
        $this->setName('run-local-codeception-tests')->setDescription('Run local codeception tests.')->setDefinition(array(new \VendorFPF\Symfony\Component\Console\Input\InputArgument(self::SINGLE, \VendorFPF\Symfony\Component\Console\Input\InputArgument::OPTIONAL, 'Name of Single test to run.', ' ')));
    }
    /**
     * Execute command.
     *
