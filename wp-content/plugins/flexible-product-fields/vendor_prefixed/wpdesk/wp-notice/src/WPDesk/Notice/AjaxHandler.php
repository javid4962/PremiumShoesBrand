...
namespace VendorFPF\WPDesk\Notice;
 ...
 */
class AjaxHandler implements \VendorFPF\WPDesk\PluginBuilder\Plugin\HookablePluginDependant
{
    use PluginAccess;
    ...
    public function processAjaxNoticeDismiss()
    {
        if (isset($_POST[self::POST_FIELD_NOTICE_NAME])) {
            ...
            $optionName = \VendorFPF\WPDesk\Notice\PermanentDismissibleNotice::OPTION_NAME_PREFIX . $noticeName;
            ...
            \update_option($optionName, \VendorFPF\WPDesk\Notice\PermanentDismissibleNotice::OPTION_VALUE_DISMISSED);
