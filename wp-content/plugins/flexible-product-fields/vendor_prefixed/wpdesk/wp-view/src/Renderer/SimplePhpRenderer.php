 ...
 */
class SimplePhpRenderer implements \VendorFPF\WPDesk\View\Renderer\Renderer
{
    /** @var Resolver */
    private $resolver;
    public function __construct(\VendorFPF\WPDesk\View\Resolver\Resolver $resolver)
    {
