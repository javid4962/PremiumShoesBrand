...
<div class="woocs_multiple_simple_panel options_group pricing woocommerce_variation" >
    ...
    <?php if ($is_fixed_enabled): ?>
        <div id="woocs_tab_fixed_restriction_<?php echo woocs_short_id($post_id) ?>" class="woocs_tab">
            ...
            &nbsp;<a href="javascript:woocs_add_all_fixed_field('<?php echo $post_id ?>','<?php echo $type ?>', '<?php echo woocs_short_id($post_id) ?>');void(0);" class="button woocs-mt-3"><?php esc_html_e('Add all', 'woocommerce-currency-switcher') ?></a>
            <br />
            <br />
            <hr class="woocs-hr-1" />
