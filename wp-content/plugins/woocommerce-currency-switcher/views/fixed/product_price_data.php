        ...
        <li id="woocs_li_geo_<?php echo $hash ?>_<?php echo $index ?>">
            ...
            <div class="variations-defaults woocs-variations-defaults">
                ...
                <p class="form-row">
                    ...
                    <select name="woocs_price_geo_countries[<?php echo $post_id ?>][<?php echo $index ?>][]" multiple="" size="1" <?php if ($index !== '__INDEX__'): ?>class="woocs_price_geo_countries chosen_select woocs_country_select" <?php else: ?>class="woocs_country_select" <?php endif; ?> data-placeholder="<?php esc_html_e('select some countries', 'woocommerce-currency-switcher') ?>">
...
<div class="woocs_multiple_simple_panel options_group pricing woocommerce_variation" style="<?php if ($type == 'simple'): ?>display: none;<?php endif; ?>">
    ...
    <?php if ($is_fixed_enabled): ?>
        <div id="woocs_tab_fixed_<?php echo woocs_short_id($post_id) ?>" class="woocs_tab">
            ...
            &nbsp;<a href="javascript:woocs_add_all_product_price('<?php echo $post_id ?>', '<?php echo woocs_short_id($post_id) ?>');void(0);" class="button woocs-mt-3"><?php esc_html_e('Add all', 'woocommerce-currency-switcher') ?></a>
            <br />
            <br />
            <hr class="woocs-hr-1" />
