            ...
            <li id="woocs_li_user_role_<?php echo $hash ?>_<?php echo $index ?>">
                <div class="woocs_price_col">
                    <p class="form-field form-row _regular_price_field">
                        ...
                        <input type="text" class="short wc_input_price" name="woocs_regular_price_user_role[<?php echo $post_id ?>][<?php echo $index ?>]" id="woocs_regular_user_role_<?php echo $hash ?>_<?php echo $index ?>" value="<?php echo $value_regular ?>" placeholder="<?php esc_html_e('auto', 'woocommerce-currency-switcher') ?>">
                    </p>
                </div>
                <div class="woocs_price_col">
                    <p class="form-field form-row _sale_price_field">
                        ...
                        <input type="text" class="short wc_input_price" name="woocs_sale_price_user_role[<?php echo $post_id ?>][<?php echo $index ?>]" id="woocs_sale_user_role_<?php echo $hash ?>_<?php echo $index ?>" value="<?php echo $value_sale ?>" placeholder="<?php esc_html_e('auto', 'woocommerce-currency-switcher') ?>">
                    </p>
                </div>            
                <div class="woocs_price_col">
                    <p class="form-row">
                ...
                <div class="variations-defaults woocs-variations-defaults">
                    <p class="form-row">
                        ...
                        ?>
                        <select name="woocs_price_user_role_name[<?php echo $post_id ?>][<?php echo $index ?>][]" multiple="" size="1" <?php if ($index !== '__INDEX__'): ?>class="woocs_price_user_role_name chosen_select "<?php endif; ?> data-placeholder="<?php esc_html_e('select user role', 'woocommerce-currency-switcher') ?>">
