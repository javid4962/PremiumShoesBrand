jQuery(document).ready(function($) {
    'use strict';
    var this_obj = shoes_store_elementor_plugin_activate_plugin;

    $('#wpelemento_importer_editor .plugin-activation-redirect a').addClass('wpi-redirect-to-dashboard');

    $(document).on('click', '.shoes-store-elementor-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message shoes-store-elementor-plugin-install');
                button.addClass('button-primary shoes-store-elementor-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.shoes-store-elementor-recommended-plugins .shoes-store-elementor-activation-note').css('display','block');
    ...
    $(document).on('click', '.shoes-store-elementor-plugin-activate', function(event) {
